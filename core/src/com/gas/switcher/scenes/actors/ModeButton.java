...
public class ModeButton extends Actor {
    ...
    private boolean isModeNine;
    private float loadScaler;
    private int wait;

    public ModeButton(final Switcher switcher, Texture texture, final String name, int renderOrder){
    ...
    public void draw(Batch batch, float parentAlpha) {
        if(isModeNine==Board.isNineMode()){
            if (animate) {
